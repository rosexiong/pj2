...
$cs_list = getcs();	
		...
		if(!empty($_POST['key'])){
			$key = $_POST['key'];
			$sqltype.= " and ( 	name like '%{$key}%' or info like '%{$key}%' )";
		}
                                            ...
                                            <div class="col-md-3 col-sm-6">
                                                <div class="item-box">
                                                    <div class="item-media entry">
                                                        <img src="upload/<?php echo $v['imgs'];?>" alt="" style="width:270px;height:180px;" class="img-responsive">
                                                        <div class="magnifier">
                                                            <div class="item-author">
                                                                <a href="detail.php?id=<?php echo $v['id'];?>">
																<img src="upload/<?php echo $v['imgs'];?>" class="img-circle" alt=""> <?php echo $v['info'];?></a>
                                                            </div><!-- end author -->
                                                        </div>
                                                        <div class="theme__button">
                                                            <p><a href="detail.php?id=<?php echo $v['id'];?>" title=""><?php echo empty($v['zt'])?'无':$v['zt'];?></a></p>
                                                        </div>
                                                    </div><!-- end item-media -->
                                                    <h4><a href="detail.php?id=<?php echo $v['id'];?>"><?php echo $v['name'];?></a></h4>
                                                    <small><a href="detail.php?id=<?php echo $v['id'];?>"><?php echo $gj_list[$v['gj']];?> / <?php echo $cs_list[$v['cs']];?></a></small>
                                                    <small><a href="detail.php?id=<?php echo $v['id'];?>"><i class="fa fa-comment-o"></i> <?php echo $v['author'];?></a></small>
                                                </div><!-- end item-box -->
                                            </div><!-- end col -->
<?php
		  }
